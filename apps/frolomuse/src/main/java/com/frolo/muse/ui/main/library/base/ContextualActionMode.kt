...
class ContextualActionMode<E: Media> constructor(
    ...
    override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean {
        val option = when(item.itemId) {
            ...
            R.id.action_scan -> Option.SCAN_FILES
            ...
            R.id.action_add_to_playlist -> Option.ADD_TO_PLAYLIST
                ...
                if (BuildConfig.DEBUG) {
                    throw IllegalArgumentException("Unexpected menu item: $item")
                } else null
            }
        }
        option?.also(onOptionSelected)
        return true
    }
    ...
    override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean {
        ...
        menu.findItem(R.id.action_scan)?.apply { isVisible = contextualMenu.scanFilesOptionAvailable }
